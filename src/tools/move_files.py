...
def create_patterns_sample(output_file="file_patterns.json"):
    """
...
def clean_folder(folder=".", patterns=None, destination=None):
    """
    ...
    organize_files(folder, destination, patterns)

if __name__ == "__main__":
    # Example usage
    create_patterns_sample()
    #clean_folder(folder="C:/Users/korde/Downloads", patterns="file_patterns.json", destination="./organized_files")